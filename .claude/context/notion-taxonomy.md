...
- **Content** (Text): Rich insight details, supports embedding images
- **Source** (Text): Where/how the insight was captured
...
- **Insights / Research** - Research findings and insights
...
Projects
  ...
  ├─ Resources (many:many)
  └─ Insights (many:many) - Related Projects relation

Tasks
  ├─ Project (many:1) - Points to Projects database
  ├─ Resources (many:many) - Links to Resources database
  └─ Insights (many:many) - Related Tasks relation on Insights
...
- **Add an Insight** when you have an observation, idea, customer quote, pattern, or strategic thought that's not yet actionable
...
- **AI topics** → Resources database (filter Area=AI), Insights (filter Work Area=AI Strategy), or Documents > AI
- **EPD work** → Projects/Tasks (filter), Insights (filter Work Area=Product), Documents > EPD, or 1:1s > EPD Team section
- **Meetings & decisions** → Meeting Transcripts, Insights (ideas/strategic thoughts), or 1:1s / Meeting Agendas pages
- **Tools & references** → Resources database (filter Type=Tool/Product)
- **Ideas & observations** → Insights database (filter by Type: Feature Idea, Customer Observation, Strategic Thought)
...
### EPD Strategy 2026
**URL:** https://www.notion.so/digible/2ade6112fa50804799c8fbb9f3687e74  
...
2. Infer Work Area
3. Create Insight with Status: Inbox
4. Confirm capture

**Example:**
```
User: "Customer just said they'd pay 2x for automated competitive monitoring"
→ Create Insight: Type=Customer Observation, Work Area=Market & Competitive + AI Strategy, 
...
- Strategy artifacts (EPD Strategy, AI Roadmap, etc.) - need individual permissions
...
1. Search across relevant databases (Tasks, Projects, Resources, Insights, Meeting Transcripts)
2. Filter by Work Area if context suggests (Insights: AI Strategy, Product, Market & Competitive, Team & Hiring, Technical, Leadership)
3. Look for relations (e.g., "show me everything about Reporting Pod" → project + tasks + resources + related insights)
...
**January 12, 2026:**
- Added **Insights database** as a core database for capturing observations, ideas, strategic thoughts, patterns, and questions
- Updated relationships map to show Insights connections to Projects and Tasks
- Updated search strategy and agent reference guide to include Insights
- Added data source ID for Insights: `collection://b9105b1d-6bdb-44f2-993b-40e324d1ba28`
